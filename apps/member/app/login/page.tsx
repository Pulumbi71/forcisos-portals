    ...
    try {
      ...
      if (data?.user) {
        ...
        if (userRole !== 'fc_student') {
          ...
          setError('Access denied. This portal is for members only.');
          return;
        }
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #1B2A4A 0%, #0d1b30 60%, #0a1520 100%)' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-white mt-1" style={{ opacity: 0.5, fontSize: '13px' }}>Member Portal</p>
        </div>
            ...
            {mode === 'login' && (
              <>
                <div className="mb-6">
                  ...
                  <p className="text-gray-500 mt-1 text-sm">Sign in to your member account</p>
                </div>
                {error && (
